...
public class CharDistributionTest {
    ...
    /**
     * Returns an array of doubles such that array[0] through array[25] are the fractions
     * of characters for 'a-z' and array[26] through array[51] are the fractions for 'A-Z'.
     *  Other characters are not included in the array or the count.
     * @param corpus the corpus
     * @return distribution gives the distribution of characters
     */
    public static double[] computeDistribution(final String corpus) {
        int lengthOfArray = 52;
        double[] distribution = new double[lengthOfArray];
    ...
    public void testEncryptAndDecrypt() {
        ...
        for (int testFixtureIndex = 0; testFixtureIndex < testFixtures.size(); testFixtureIndex++) {
            ...
            double[] distribution = CharDistribution.computeDistribution(text); // the name of method is computeDistribution(text)
