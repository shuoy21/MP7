...
public class Winner {
    ...
    public static String winner(final int firstScore, final int secondScore, final int thirdScore) {
        int curMax = Math.max(firstScore, secondScore);
        int curMin = Math.min(firstScore, secondScore);
        if (thirdScore > curMax) {
            return thirdScore + ", " + curMax + ", " + curMin;
        } else if (thirdScore > curMin) {
            return curMax + ", " + thirdScore + ", " + curMin;
        } else {
            return curMax + ", " + curMin + ", " + thirdScore;
        }
    }
    /**********************************************************************************************
